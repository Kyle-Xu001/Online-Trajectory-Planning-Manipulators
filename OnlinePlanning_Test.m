...
figure(1)
subplot(6,1,1)
plot(0.001*(1:num+1),dq_List(:,1));xlabel('Time/s');ylabel('Speed/rad·s^{-1}');
subplot(6,1,2)
plot(0.001*(1:num+1),dq_List(:,2));xlabel('Time/s');ylabel('Speed/rad·s^{-1}');
subplot(6,1,3)
plot(0.001*(1:num+1),dq_List(:,3));xlabel('Time/s');ylabel('Speed/rad·s^{-1}');
subplot(6,1,4)
plot(0.001*(1:num+1),dq_List(:,4));xlabel('Time/s');ylabel('Speed/rad·s^{-1}');
subplot(6,1,5)
plot(0.001*(1:num+1),dq_List(:,5));xlabel('Time/s');ylabel('Speed/rad·s^{-1}');
subplot(6,1,6)
plot(0.001*(1:num+1),dq_List(:,6));xlabel('Time/s');ylabel('Speed/rad·s^{-1}');
...
figure(3)
subplot(6,1,1)
plot(0.001*(1:num+1),ddq_List(:,1));xlabel('Time/s');ylabel('Acceleration/rad·s^{-2}');
subplot(6,1,2)
plot(0.001*(1:num+1),ddq_List(:,2));xlabel('Time/s');ylabel('Acceleration/rad·s^{-2}');
subplot(6,1,3)
plot(0.001*(1:num+1),ddq_List(:,3));xlabel('Time/s');ylabel('Acceleration/rad·s^{-2}');
subplot(6,1,4)
plot(0.001*(1:num+1),ddq_List(:,4));xlabel('Time/s');ylabel('Acceleration/rad·s^{-2}');
subplot(6,1,5)
plot(0.001*(1:num+1),ddq_List(:,5));xlabel('Time/s');ylabel('Acceleration/rad·s^{-2}');
subplot(6,1,6)
plot(0.001*(1:num+1),ddq_List(:,6));xlabel('Time/s');ylabel('Acceleration/rad·s^{-2}');
